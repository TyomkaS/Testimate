...
public class DBResViewer
{
    ...
    //Конструкторы
    public DBResViewer(JPanel parent)
    {
    ...
    public DBResViewer(DBPriceViewer parent)
    {
        this.parent=parent;
        this.viewerbase = new JPanel();
    ...
    public DBPriceViewer getParent() {return this.parent;}
    ...
    private DBResViewer getSelfLink(){return this;}
    ...
    public void setBounds(int top, int width)
    {
        ...
        int resNameWidth=this.width-0-14*45-75-16;
        ...
        this.normalCount.setBounds(afetrNameHorizBegin,0,135,20);
        afetrNameHorizBegin+=afetrNameStep*3;
